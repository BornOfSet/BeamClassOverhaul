...
local CDFParticleCannonWeapon = import('/mods/SupremeWarfare4k/Contents/Weapons/AdaptiveLaser_2.lua').AdaptiveLaser

CybranLaserTank_3 = Class(CLandUnit) {
    Weapons = {
	...
	OnLostTarget = function(self , weapon) --This OnLostTarget makes it possible to go outside complex states pile and see effects directly
		weapon:OnLostTargetCallback(self)
	end
}

TypeClass = CybranLaserTank_3