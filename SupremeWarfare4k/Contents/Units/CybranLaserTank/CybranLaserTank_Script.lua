...
local CDFParticleCannonWeapon = import('/mods/SupremeWarfare4k/Contents/Weapons/AdaptiveLaser.lua').AdaptiveLaser

CybranLaserTank = Class(CLandUnit) {
    Weapons = {
